...
export default function CropView({ cropName, back, shopData, blogs, cart, addToCart, addAllToCart }) {
  // Find crop data
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-800 mb-2" data-testid="crop-view-title">
                {cropName}
              </h1>
              <p className="text-gray-600 text-lg">
                {cropBlogs.length > 0 ? `${cropBlogs.length} पोस्ट उपलब्ध` : 'अद्याप पोस्ट उपलब्ध नाहीत'}
              </p>
            </div>
          </div>
        </div>
